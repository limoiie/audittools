...
set(RXCPP_ROOT_DIR ${AUDITTOOLS_DIR}/ext/rxcpp)
include(${RXCPP_ROOT_DIR}/projects/CMake/shared.cmake)

include_directories(${RXCPP_ROOT_DIR}/${RX_SRC_DIR})
...
function(config_target_for_rxcpp TARGET_NAME)
  ...
  target_include_directories(${TARGET_NAME} 
    PUBLIC ${RXCPP_ROOT_DIR}/${RX_SRC_DIR} ${RXCPP_ROOT_DIR}/${RX_CATCH_DIR}
  )
